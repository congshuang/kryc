module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro.v4': '客如云组件库 Pro v4',
    ...
    'app.home.slogan': '一个组件库',
    'app.home.introduce':
      '客如云内部组件系统,主要对内部组件的进行整理规整，使其使用和扩展更合理化',
    'app.home.design-language': '设计语言',
    'app.home.solution': '解决方案',
    'app.home.components-explain':
      '基于 客如云组件库 设计语言，我们提供了开箱即用的高质量 React 组件实现，用于开发和服务于企业级中后台产品。',
    'app.home.product-pro-slogan': '开箱即用的中台前端/设计解决方案',
    'app.home.product-mobile-slogan': 'antd-mobile 是 客如云组件库 移动规范的实现',
    'app.home.product-antv-slogan': '简单、专业、拥有无限可能的数据可视化解决方案',
    'app.home.product-landing-slogan': '基于 客如云组件库 设计语言的 Landing 模板与规范',
    'app.home.tool-title': '工具和资源',
    'app.home.tool-package-title': '客如云组件库 资源包',
    'app.home.tool-package-content': '客如云组件库 相关设计资源下载',
    ...
    'app.home.more': '查看更多',
    'app.home.more-mobile-react': '客如云组件库 Mobile of React',
    'app.home.more-mobile-angular': '客如云组件库 Mobile of Angular',
    'app.footer.repo': 'GitHub 仓库',
    'app.footer.awesome': 'Awesome 客如云组件库',
    'app.footer.course': '客如云组件库 实战教程',
